...
class ExpressionTypeParser(ast.NodeVisitor):
    def __init__(self, scope):
        ...
        self.bool = itypes.get_type_by_name('<bool>')
    ...
    def get_type(self, expression):
        ...
        if result is None:
            ...
            return itypes.UnknownType()
        return result

    def visit_Num(self, node):
        return itypes.get_type_by_value(node.n)

    def visit_Str(self, node):
        return itypes.get_type_by_value(node.s)
    ...
    def visit_NameConstant(self, node):
        return itypes.get_type_by_value(node.value)
    ...
    def visit_IfExp(self, node):
        return itypes.TypeSet(self.get_type(node.body), self.get_type(node.orelse))
